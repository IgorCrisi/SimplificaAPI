...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, name, usuario, password, usuario_update, updateProfile, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = request.user.id;
                        _a = request.body, name = _a.name, usuario = _a.usuario, password = _a.password, usuario_update = _a.usuario_update;
