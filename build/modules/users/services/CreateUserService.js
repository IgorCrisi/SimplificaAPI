...
var CreateUserService = /** @class */ (function () {
    function CreateUserService(usersRepository, lojaRepository) {
    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var usuarioExists, lojaExists, hashedPassword, userSave;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByUser(user)];
                    case 1:
                        usuarioExists = _b.sent();
                        if (usuarioExists) {
                            throw new AppError_1.default('Este usuário já foi usado');
                        }
                    ...
                    case 3:
                        ...
                        userSave = this.usersRepository.create({
                            name: name,
                            user: user,
