...
var ResetPasswordService = /** @class */ (function () {
    function ResetPasswordService(usersRepository) {
        this.usersRepository = usersRepository;
    }
    ResetPasswordService.prototype.execute = function (_a) {
        var id = _a.id, password = _a.password, usuario_update = _a.usuario_update;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('O usuário não existe');
                        }
                        _b = user;
