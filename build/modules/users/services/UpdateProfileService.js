...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        var id = _a.id, name = _a.name, usuario = _a.usuario, password = _a.password, usuario_update = _a.usuario_update;
        return __awaiter(this, void 0, void 0, function () {
            var user, userExist, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.usersRepository.findByUser(usuario)];
                    case 2:
                        userExist = _c.sent();
                        ...
                        user.name = name;
                        user.user = usuario;
                        if (!(password != null)) return [3 /*break*/, 4];
                        _b = user;
